...
import static ru.job4j.arrays.Cinema.Place;
...
class CinemaTest {
    ...
    @Test
    public void checkEmptyPlaceReverse() {
        Place[][] places = {
                {new Place(0, 0), new Place(0, 1), new Place(0, 2)},
                {new Place(1, 0), null, null},
                {new Place(2, 0), null, new Place(2, 2)}
        };
        Place rsl = Cinema.checkEmptyPlace(places);
        assertThat(rsl, is(nullValue()));
    }
    ...
    @Test
    public void checkEmptyPlaceIsNullSide() {
        Place[][] places = {
                {new Place(0, 0), null, new Place(0, 2), null, new Place(0, 4)},
                {null, new Place(1, 1), null, new Place(1, 3), null},
                {new Place(2, 0), null, new Place(2, 2), null, null},
                {null, new Place(3, 1), null, new Place(3, 3), null},
                {new Place(4, 0), new Place(4, 1), new Place(4, 2), null, new Place(4, 4)}
        };
        Place rsl = Cinema.checkEmptyPlace(places);
        Place expected = new Place(2, 4);
        assertThat(rsl, is(expected));
    }
}